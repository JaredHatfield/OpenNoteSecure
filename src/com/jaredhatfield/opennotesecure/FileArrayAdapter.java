...
public class FileArrayAdapter extends ArrayAdapter<File> {
     ...
     * 
     * @param context
     *            The context for the array adapter.
     * @param textViewResourceId
     *            The resource identifier.
     * @param objects
     *            The list that will be used.
     */
     ...
     * 
     * @param position
     *            The position that is being requested.
     * @param currentView
     *            The current view that can be reused.
     * @param parent
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.setText((TextView) convertView
                    .findViewById(R.id.FileRowText));
